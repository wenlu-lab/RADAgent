---
name: gbs-0-lane-info
description: Run GBS pipeline Step 0 (prepare lane info) directly on the server
context: fork
model: sonnet
allowed-tools: Bash, Read, Grep, Glob
---

# GBS Pipeline — Step 0: Prepare Lane Info

You are running GBS pipeline Step 0 directly on the server. All paths are relative to the project root (`gbs_data/`). Before running any commands, detect the project root:
