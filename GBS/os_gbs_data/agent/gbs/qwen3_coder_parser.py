"""Parse Qwen3-Coder native tool-call markup into structured ToolCalls.

Qwen3-Coder emits tool calls in an XML-ish form (the same format vLLM's
--tool-call-parser qwen3_coder consumes):
...
from gbs.llm_types import ToolCall
