...
moved here because the Qwen-driven orchestrator was ignoring the SKILL.md
...
def project_root_from(session_dir: str | Path) -> Path:
    """Recover project root from a session_dir path (.gbs/transcripts/<id>/)."""
    p = Path(session_dir).resolve()
    # session_dir = <root>/.gbs/transcripts/<id>
    # walk up to <root>
...
_CHECKS: dict[str, Callable[[Path], tuple[bool, str]]] = {
    "gbs-0-lane-info":     _check_step_0,
    "gbs-1-cutadapt":      _check_step_1,
    "gbs-2-radtags":       _check_step_2,
    "gbs-3-rename":        _check_step_3,
    "gbs-4-popmap":        _check_step_4,
    "gbs-5-bwa":           _check_step_5,
    "gbs-6-gstacks":       _check_step_6,
    "gbs-7-populations":   _check_step_7,
    "gbs-8-vcf-filter":    _check_step_8,
    "gbs-9-snp-dup-hwe":   _check_step_9,
    "gbs-10-ld-clump":     _check_step_10,
    "gbs-11-remove-atgc":  _check_step_11,
    "gbs-12-maf-filter":   _check_step_12,
    "gbs-13-flanking":     _check_step_13,
    "gbs-14-blast-map":    _check_step_14,
    "gbs-15-even-dist":    _check_step_15,
}
