#!/usr/bin/env python3
"""Browse RAD pipeline skill transcripts stored by Claude Code.
...
If a session contains multiple pipeline runs (e.g., you ran /rad-orchestrator twice),
...
PROJECT_DIR = Path.home() / ".claude" / "projects" / "-home-mreddy1-rad-data"
...
def main():
    parser = argparse.ArgumentParser(description="Browse RAD pipeline skill transcripts")
