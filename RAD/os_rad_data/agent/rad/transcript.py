...
(browse_transcripts.py, rad_token_tracker.py) work with minimal patching.
"""
...
from rad.llm_client import ChatMessage, ToolCall
...
class TranscriptWriter:
    ...
    def record_assistant(self, msg: ChatMessage, model_label: str = "phi-4") -> None:
        usage_obj = {
