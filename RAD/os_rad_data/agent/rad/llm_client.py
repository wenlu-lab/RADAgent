"""In-process LLM client: loads Phi-4 via transformers and generates
...
Phi-4 tool-call markup; coder_tool_parser turns it back into structured
...
import torch
from rad.llm_types import TokenUsage, ToolCall, ChatMessage  # re-exported
from rad.model_backend import get_model
from rad.coder_tool_parser import parse
