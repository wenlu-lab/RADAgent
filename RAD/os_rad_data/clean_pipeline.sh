#!/bin/bash
# Clean RAD pipeline outputs — keeps raw FASTQs, scripts, genome, and skill-created tools
...
# Resolve the project root to this script's own directory (like ./rad),
